...
export default function LeafletMapProvider({ points }: MapProviderProps) {
  ...
  return (
    <div
      className="h-72 overflow-hidden rounded-xl border border-stone-300 [&_.leaflet-container_.leaflet-control-attribution]:bg-white"
      role="region"
